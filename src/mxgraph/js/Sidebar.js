...
/**
 * Specifies if stencil files should be loaded and added to the search mxgraph
...
/**
 * Adds the give entries to the search mxgraph.
 */
...
/**
 * Adds the DDD library to the sidebar.
 */
Sidebar.prototype.addDDDPalette = function()
{
	// Avoids having to bind all functions to "this"
	var sb = this;

	// Reusable cells
	var field = new mxCell('+ Identity: type', new mxGeometry(0, 0, 100, 26), 'text;strokeColor=none;fillColor=none;align=left;verticalAlign=top;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	field.vertex = true;
	...
	// Default tags
	var dt = 'DDD pattern class ';
	this.setCurrentSearchEntryLibrary('DDD');

	var fns = [
		this.addEntry(dt + 'classifier', function()
		{
			var cell1 = new mxCell('&lt;&lt;Entity&gt;&gt;<br><b>ClassName</b>', new mxGeometry(0, 0, 140, 183),
				'swimlane;fontStyle=0;align=center;verticalAlign=top;childLayout=stackLayout;horizontal=1;startSize=55;horizontalStack=0;resizeParent=1;resizeParentMax=0;resizeLast=0;collapsible=0;marginBottom=0;html=1;');
			cell1.vertex = true;
			var field1 = new mxCell('attributes',
				new mxGeometry(0, 0, 140, 20), 'text;html=1;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;spacingLeft=4;spacingRight=4;overflow=hidden;rotatable=0;points=[[0,0.5],[1,0.5]];portConstraint=eastwest;');
	...
	//Add to SideBar
	this.addPaletteFunctions('DDD','DDD pattern' + mxResources.get('uml'), 'uml', fns);
	this.setCurrentSearchEntryLibrary();
